...
public class rotatingArmController {
    ...
    public rotatingArmController(double lKP, double lKI, double lKD, double lKF, double sKP, double sKI, double sKD, double sKF) {
        this.lKP = lKP;
        this.lKI = lKI;
        this.lKD = lKD;
        this.lKF = lKF;
    ...
    public void updateConstants(double lKP, double lKI, double lKD, double lKF, double sKP, double sKI, double sKD, double sKF) {
        this.lKP = lKP;
        this.lKI = lKI;
        this.lKD = lKD;
        this.lKF = lKF;
    ...
    public double run(double currentAngle, double targetAngle) {
        ...
        if(error > errorZone) {
            ...
            feedForward = lKF * Math.signum(currentAngle - middlePoint);
        }else{
            proportional = sKP * error;
            integral += sKI * error * deltaTime;
            derivative = sKD * (error - previousError) / deltaTime;
            feedForward = sKF * Math.signum(currentAngle - middlePoint);
        }
