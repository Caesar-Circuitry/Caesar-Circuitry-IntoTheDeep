...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = .001978305688;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = -0.0019785959409209233;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = -0.0019785959409209233;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-1.5, 4.5, 0);
        rightEncoderPose = new Pose(-1.5, -4.5, 0);
        strafeEncoderPose = new Pose(-5.5, 0, Math.toRadians(90));

        hardwareMap = map;

        // TODO: replace these with your encoder ports
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FRM"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "par1"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "BRM"));
