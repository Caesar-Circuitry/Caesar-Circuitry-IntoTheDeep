...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "FLM";
    public static String leftRearMotorName = "BLM";
    public static String rightFrontMotorName = "FRM";
    public static String rightRearMotorName = "BRM";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 73.40525666061554;
    private static double yMovement = 60.70026851870845;
    ...
    public static double mass = 9.05;
    ...
    public static double forwardZeroPowerAcceleration = -27.177929688412906;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -57.85190792456458;
