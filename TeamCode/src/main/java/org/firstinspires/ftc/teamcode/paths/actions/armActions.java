...
public class armActions {
    ...
    public static double neutralAngle = 25, SUBAngle = 13, intakeSample = 255, intakeSpecimen = 35, basketAngle = 125, HangAngle = 150, BarUpAngle = 78, HANGDOWNANGLE = 360,
            clawOpen = .9, clawClosed = .62, clawWristPickup = .05, clawWristBucket = 1, clawWristSpecimen = 0.5, clawWristSUB = .05, multiplier = 1,
            viperbasket = 17, viperZero = .1, viperBar = 4.5;
