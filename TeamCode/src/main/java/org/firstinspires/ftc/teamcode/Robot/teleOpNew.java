...
public class teleOpNew extends LinearOpMode {
    ...
    private boolean subIntake = false, speciHang = false;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.right_bumper && gamepad1.y) {
                ...
                HangAngle = 150;
            } else if (targetPos == Pos.HANG_ANGLE && gamepad1.x) {
                targetPos = Pos.HANG_ANGLE;
    ...
    private void states() {
        switch (targetPos) {
            ...
            case SUB:
                ...
                armMath(); // be ready for it not to work
                dirCode(SUBAngle, 12, rotateServoAngle +.02);
                break;
            case HANG_ANGLE:
                if (liftLastPos_ticks / LIFT_TICKS_PER_IN <= LastViperLengthAdjusted) {
                    dirState = true;
